          ...
          <Container maxWidth='lg'>
            ...
            >
              <Box>
                ...
                <Typography sx={{ mb: 3, opacity: 0.8, lineHeight: 1.6 }}>
                  Hệ thống quản lý bảo trì thiết bị gia dụng chuyên nghiệp, giúp
                  bạn theo dõi và bảo trì thiết bị một cách hiệu quả.
                </Typography>
                <Box sx={{ display: 'flex', gap: 2 }}>
            ...
            >
              <Typography sx={{ opacity: 0.8 }}>
                © 2024 Maintenance Pro. Tất cả quyền được bảo lưu.
              </Typography>
